...
Based on Part 2 Guide: Face Tracking with Identity Lock (Appendix A2).
"""
...
from src.cam_config import get_cam_index
...
def main():
    ...
    parser.add_argument("--camera", type=int, default=get_cam_index())
